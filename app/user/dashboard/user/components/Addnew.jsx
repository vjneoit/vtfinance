    ...
    return (
        <div>
            ...
            <div className="grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-4">
                <CategoryLink href="/user/dashboard/user/insurance" icon={<FaShieldAlt size={32} />} title="Insurance" color="bg-purple-200" />
                <CategoryLink href="/user/dashboard/user/loan" icon={<FaMoneyCheckAlt size={32} />} title="Loan" color="bg-green-200" />
                <CategoryLink href="/user/dashboard/user/rto" icon={<FaCar size={32} />} title="RTO" color="bg-blue-200" />
            </div>
        </div>
    );
}
