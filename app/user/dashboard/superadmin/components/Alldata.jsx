...
import { FaShieldAlt, FaMoneyCheckAlt, FaCar, FaSave,FaUserAlt } from 'react-icons/fa'; // Import FaSave icon
    ...
    return (
        <div>
            ...
            <div className="grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-4">
                <CategoryLink href="/user/dashboard/superadmin/alldata/users" icon={<FaUserAlt size={32} />} title="User" color="bg-gray-200" />
                <CategoryLink href="/user/dashboard/superadmin/alldata/insurance" icon={<FaShieldAlt size={32} />} title="Insurance" color="bg-purple-200" />
                <CategoryLink href="/user/dashboard/superadmin/alldata/loan" icon={<FaMoneyCheckAlt size={32} />} title="Loan" color="bg-green-200" />
                <CategoryLink href="/user/dashboard/superadmin/alldata/rto" icon={<FaCar size={32} />} title="RTO" color="bg-blue-200" />
            </div>
        </div>
    );
}
